...
@Component({
  selector: 'app-votes-stations',
  templateUrl: './votes-stations.component.html',
  styleUrls: ['./votes-stations.component.css']
})
export class VotesStationsComponent implements OnInit {
  ...
  allRadioStationList() {
    ...
    this.apicall.getAllVotesListJson().subscribe(res => {
