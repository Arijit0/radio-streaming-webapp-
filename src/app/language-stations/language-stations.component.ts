...
@Component({
  selector: 'app-language-stations',
  templateUrl: './language-stations.component.html',
  styleUrls: ['./language-stations.component.css']
})
export class LanguageStationsComponent implements OnInit {
  ...
  getEachLanguageList() {
    ...
    let languageName = this.route.snapshot.paramMap.get('language-name');
    this.apicall.eachLanguageJson(languageName).subscribe(res => {
