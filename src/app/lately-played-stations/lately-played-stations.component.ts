...
@Component({
  selector: 'app-lately-played-stations',
  templateUrl: './lately-played-stations.component.html',
  styleUrls: ['./lately-played-stations.component.css']
})
export class LatelyPlayedStationsComponent implements OnInit {
  ...
  allRadioStationList() {
    ...
    this.apicall.getAllLastClickedListJson().subscribe(res => {
