...
@Component({
  selector: 'app-tags-stations',
  templateUrl: './tags-stations.component.html',
  styleUrls: ['./tags-stations.component.css']
})
export class TagsStationsComponent implements OnInit {
  ...
  getEachtagList() {
    ...
    let tagName = this.route.snapshot.paramMap.get('tag-name');
    this.apicall.eachTagJson(tagName).subscribe(res => {
