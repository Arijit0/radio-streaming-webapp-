...
@Component({
  selector: 'app-country-stations',
  templateUrl: './country-stations.component.html',
  styleUrls: ['./country-stations.component.css']
})
export class CountryStationsComponent implements OnInit {
  ...
  getEachCountryList() {
    ...
    let countryName = this.route.snapshot.paramMap.get('country-name');
    this.apicall.eachCountryJson(countryName).subscribe(res => {
